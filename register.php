...
<body>
    <div class="m-0 p-0" style="display: flex; height: 100vh; width: 100%;">
        <div class="left">
            ...
            <h1 style="color: #ffffff;"><b>Register Account</b></h1>
            ...
            <div class="card-body">
                <form action="login.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tesxt" class="form-control" id="Phone" name="Phone">
                    </div>
                    <div class="mb-3">
                ...
                <div class="mb-3">
                    <p id="login">Back To Login: <a href="login.html">Login</a></p>
                </div>
            </div>
        </div>
    </div>
